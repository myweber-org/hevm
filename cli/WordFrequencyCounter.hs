...
sortWordCounts :: WordCount -> [(T.Text, Int)]
sortWordCounts = List.sortBy (\(_, cnt1) (_, cnt2) -> compare cnt2 cnt1) . Map.toList
...
processText = formatOutput . sortWordCounts . countWords
...
main = do
    ...
    printWordCounts top3module WordFrequencyCounter where
